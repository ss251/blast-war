...
export default function GameLauncher({ startGame, gameData }: GameLauncherProps) {
  return (
    <Card className="bg-gradient-to-b from-purple-900 to-indigo-900 text-white shadow-xl rounded-3xl overflow-hidden border border-purple-500 flex flex-col h-full">
